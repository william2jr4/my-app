...
Route::group(['middleware' => 'auth:teacher,web,ortu'], function() {
    ...
    Route::group(['middleware' => 'auth:web'], function() {
        ...
        Route::post('/insert-file', [AdminController::class, 'insertFile'])->name('insert_file');
        Route::get('/file', [AdminController::class, 'indexFile'])->name('index_file');
    });
    Route::group(['middleware' => 'auth:ortu'], function() {
        Route::resource('ortu', OrtuController::class);
    } );

    Route::group(['middleware' => 'auth:web,ortu'], function() {
        Route::get('/download-file/{files}', [AdminController::class, 'download'])->name('download');
    });

    Route::group(['middleware' => 'auth:ortu'], function() {
        Route::get('/message', [OrtuController::class, 'message'])->name('ortu.message');
        Route::resource('ortu', OrtuController::class);
    } );
});