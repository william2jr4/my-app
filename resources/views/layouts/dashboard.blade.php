...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="{{ route('dashboard.index') }}">Monitoring Student</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="menuAdmin" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="{{ route('index_file') }}">Jadwal</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="room" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="{{ route('classgroup.index') }}">Perwalian</a>
                                </nav>
                            </div>
                            {{-- END MENU ADMIN --}}
                            @endif
